...
def register(model_name: str, training_type: Literal["lora", "sft", "cond_lora"], trainer_cls: Trainer):
...
def get_model_cls(model_type: str, training_type: Literal["lora", "sft", "cond_lora"]) -> Trainer:
