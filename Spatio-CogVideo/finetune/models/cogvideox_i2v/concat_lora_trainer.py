...
from ..pipelines.pipeline import ConcatPipeline
...
from ..transformers.transformer import ConcatTransformer

class CogVideoXI2VConcatLoraTrainer(Trainer):
    ...
    def load_components(self) -> Dict[str, Any]:
        ...
        components.pipeline_cls = ConcatPipeline

        components.tokenizer = AutoTokenizer.from_pretrained(model_path, subfolder="tokenizer")

        components.text_encoder = T5EncoderModel.from_pretrained(model_path, subfolder="text_encoder")

        components.transformer = ConcatTransformer.from_pretrained(model_path, subfolder="transformer")
...
register("cogvideox-i2v", "concat_lora", CogVideoXI2VConcatLoraTrainer)
